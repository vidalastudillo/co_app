...
**Por qué.** Decisión de diseño del proyecto. No se reutilizó Support/Issue porque ese módulo cierra automáticamente tickets resueltos, destruyendo el rastro; tampoco Help Article existe en Frappe v15. Todas las máquinas necesarias —timeline, notificaciones, [track_changes](../referencias.md)— las provee Frappe base para cualquier DocType.
...
**Límites.** Sin gates de rol en transiciones de estado: discipline manual. El timeline vive en comentarios nativos, no como entradas modeladas (conversación no se busca por índice en el ERP). Los recordatorios automáticos (email semanal) dependen de Email Account configurada en producción. Evaluación de "está respondida" es manual, no automática por condición.
