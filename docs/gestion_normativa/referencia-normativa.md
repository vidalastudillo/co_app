...
**Por qué.** Decisión de diseño del proyecto. Los códigos de sección son inmutables (siguiendo el modelo de la Estructura Tributaria colombiana: una sección, una vez publicada, jamás se renumera). Esto permite que una cita "§11.2" siga válida aún si la estructura se reorganiza — buscar referencias por número afectado es entonces una consulta manual de integridad.
